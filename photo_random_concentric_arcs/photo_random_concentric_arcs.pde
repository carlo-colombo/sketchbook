...
String filename = "/home/ilich/sketchbook/photos/MVIMG_20190912_184921.jpg";
...
void _draw(int i) {
  ...
  for (int j =0;j< circles; j++){
    ...
    stroke(c);
    arc(0,0, radius*2, radius*2, radians(random(0, 120)), radians(random(240,360)));
  }
  popMatrix();
